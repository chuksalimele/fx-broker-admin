...
import chuks.flatbok.fx.common.util.log.LogLevel;
...
import chuks.flatbok.fx.common.account.profile.ClientIPInfo;
...
public class AdminManager implements AdminAccount {
    ...
    public void onAdminActivated() {
        adminAccountListenerList.forEach(listener -> {
            listener.onAdminActivated();
        });
    }

    @Override
    public void onAdminDeactivated() {
        adminAccountListenerList.forEach(listener -> {
            listener.onAdminDeactivated();
        });
    }
